...
header() {
  ...
  cat <<"EOF"
    ____  ____  ____  __________  __  ___________________
   / __ \/ __ \/ __ \/_  __/ __ \/ / / / ____/ ___/_  __/
  / /_/ / / / / / / / / / / / / / / / / __/  \__ \ / /   
 / _, _/ /_/ / /_/ / / / / /_/ / /_/ / /___ ___/ // /    
/_/ |_|\____/\____/ /_/  \___\_\____/_____//____//_/     
...
intro() {
  ...
  echo -e "${BLUE} Kausal S D"
  echo -e "${BLUE} Prathunan K"
  echo -e "${RED} RootQuest - A linux Subo Vulnerability Scanner"
  echo -e "\n"
  echo -e "\n"
  echo -e "${BOLD}${GREEN}Strating Scan.... ${RESET}"
...
checkinitial() {
  ...
  if [ "$sudoperms" ]; then
    echo -e "${BOLD}${GREEN}UDO possible without a password!${RESET}\n\n$sudoperms"
    echo -e "\n"
  fi
